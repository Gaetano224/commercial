...
export const LightbulbIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.355a7.5 7.5 0 0 1-3 0m3 0a7.5 7.5 0 0 0-3 0m.375 0a6.003 6.003 0 0 0-3.75 0m0 0a6.003 6.003 0 0 1-3.75 0m0 0a6.003 6.003 0 0 0-3.75 0m0 0a6.003 6.003 0 0 1-3.75 0M12 6.75A2.25 2.25 0 0 1 14.25 9v1.083c-.068.02-.138.033-.209.051a4.502 4.502 0 0 0-4.082 0c-.07-.018-.14-.032-.208-.051V9A2.25 2.25 0 0 1 12 6.75Z" />
  </svg>
);
...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 2L9.813 9.813 2 12l7.813 2.187L12 22l2.187-7.813L22 12l-7.813-2.187L12 2ZM4.5 4.5l1.5 1.5M18 18l1.5 1.5M4.5 19.5l1.5-1.5M18 6l1.5-1.5" />
    </svg>
);
...
export const ChatBubbleLeftEllipsisIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-3.861 8.25-8.625 8.25C7.861 20.25 4 16.556 4 12c0-4.556 3.861-8.25 8.625-8.25 4.764 0 8.625 3.694 8.625 8.25Z" />
  </svg>
);
